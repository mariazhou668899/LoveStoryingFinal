...
const generateStory = async () => {
    try {
      ...
      // Generate Title
      //===============================
      const titleResponse = await OpenAIServices.titleGeneration('test');
      ...
      //Generate Questions
      //=======================
      const responseQuestion = await OpenAIServices.questionsGenerator('test');
      ...
      navigation.navigate('ViewStory', { theStoryTitle: storyTitle, theStoryData: storyData, theCoverURL: imageData.imgURL[0], sGenre: genre, uAge: age, questionsResponse: questions}); //=======
